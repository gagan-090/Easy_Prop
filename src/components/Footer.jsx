        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-2xl font-bold">EasyProp</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Your trusted partner in real estate. We make buying and selling properties easy, 
              transparent, and hassle-free. Find your dream property with us.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/properties" className="text-gray-300 hover:text-primary-400 transition-colors">
                  Properties
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-300">info@easyprop.com</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 EasyProp. All rights reserved.
            </p>
